...
Fremstil i nedenstående SynthDef en kompleks klang ved hjælp af additiv syntese med sinustoner (eksempler herpå kan findes i artiklen om [additiv syntese](Art2-Additive-bølger.md)). Klangen skal overholde følgende krav:
