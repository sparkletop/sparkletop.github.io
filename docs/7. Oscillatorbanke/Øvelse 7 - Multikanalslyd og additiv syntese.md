...
1. Klangen skal ud over grundtonen indeholde mindst tre forskellige overtoner (dvs. med et harmonisk forhold til freq)
1. Klangen skal derudover indeholde mindst to forskellige partialtoner (dvs. med et inharmonisk forhold til freq)
1. Hver tone skal tildeles en unik amplitude
...
Bonusudfordring til særligt interesserede læsere:

1. Tilføj et element af filtreret støj helt i begyndelsen af anslaget
...
## Opgave 4: Additive klangflader

Udfyld nedenstående SynthDef, således at de 16 stemmer hver indeholder følgende:
