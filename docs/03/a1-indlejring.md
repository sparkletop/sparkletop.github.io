...
Vi har tidligere set, [hvordan `Pseq` kan generere sekvenser af værdier](../02/a1-patterns-intro.md). Men `Pseq` er fleksibel og kan lige så vel bruges til sekvenser af patterns. Her eksempelvis en sekvens med en blanding af faste og tilfældigt genererede skalatrin:
