...
Du kan finde hjælp og eksempler i [filter-cheat sheetet](c1-filtre.md).
...
Brug følgende kilder til at modulere cutoff-frekvensen for et low pass-filter, så cutoff-frekvensen bevæger sig mellem 500Hz og 1000Hz (se evt. [artiklen om modulation af UGens](../04/a2-skalering.md) for relevante teknikker).
...
Omskriv kildekoden fra Opgave 2 til en SynthDef, som gør brug af subtraktiv syntese. Du kan evt. gøre brug af en [SynthDef-skabelon](../05/c1-synthdef.md) som ramme for dit arbejde.
