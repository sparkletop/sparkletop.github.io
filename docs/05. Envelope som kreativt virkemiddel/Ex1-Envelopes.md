...
2. Skriv en `Pmono`-baseret komposition, hvor du varierer `\degree`, `\lfoFreq` og `\lfoDepth` ved hjælp af patterns, fx [tilfældighedsgeneratorer](../02. Generativ komposition med patterns/Art2-Tilfældighedsgeneratorer.md).
